	...
	return (
		<div className="grid min-h-screen grid-cols-1 gap-4 pt-1 md:grid-cols-2 lg:grid-cols-3">
			<div>
				...
				<SkeletonText className="mb-2" size={85} type="h1" />
				<SkeletonText className="mb-2" size={95} type="h1" />
			...
			<div className="hidden md:block">
				...
				<SkeletonText className="mb-2" size={75} type="h2" />
				<SkeletonText className="mb-4" size={55} type="h2" />
			...
			<div className="hidden lg:block">
				...
				<SkeletonText className="mb-2" size={80} type="h1" />
				<SkeletonText className="mb-1.5" size={85} />
				<SkeletonText className="mb-1.5" size={95} />
				<SkeletonText className="mb-1.5" size={75} />
			</div>
